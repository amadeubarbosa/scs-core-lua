...
-- OiL configuration
local orb = oil.init({host = "localhost", port = 2620, localrefs = "proxy"})
...
oil.main(function()
  ...
  local keys = { IComponent = "CompositeComponent" }
  local componentId = { name = "CompositeComponent", major_version = 1, minor_version = 0, patch_version = 0, platform_spec = "" }
