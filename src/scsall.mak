...
${PRECMP_DIR}/scsall.c ${PRECMP_DIR}/scsall.h: ${PRECMP_DIR}/scs_core_base.h ${PRECMP_DIR}/scs_core_utils.h  ${PRECMP_DIR}/scs_adaptation_AdaptiveReceptacle.h ${PRECMP_DIR}/scs_adaptation_OilUtilities.h
	${LUABIN} ${PRELOAD_LUA} -o scsall ${PRELOAD_FLAGS} ${PRECMP_DIR}/scs_core_base.h ${PRECMP_DIR}/scs_core_utils.h ${PRECMP_DIR}/scs_adaptation_AdaptiveReceptacle.h  ${PRECMP_DIR}/scs_adaptation_OilUtilities.h
...
SRC= ${PRECMP_DIR}/scs_core_base.c ${PRECMP_DIR}/scs_core_utils.c ${PRECMP_DIR}/scs_adaptation_AdaptiveReceptacle.c ${PRECMP_DIR}/scs_adaptation_OilUtilities.c ${PRECMP_DIR}/scsall.c
