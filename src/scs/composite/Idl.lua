...
idl = {
  throw = {
      ...
      FacetAlreadyExists = "IDL:scs/composite/FacetAlreadyExists:1.0",
      IncompatibleInterfaces = "IDL:scs/composite/IncompatibleInterfaces:1.0",
      ReceptacleNotFound = "IDL:scs/composite/ReceptacleNotFound:1.0",
      ReceptacleAlreadyExists = "IDL:scs/composite/ReceptacleAlreadyExists:1.0",
